...
package com.leap.cluster

import akka.actor.{Actor, ActorRef} // need to change this..

import com.typesafe.config.{Config, ConfigFactory}
import com.leap.cluster.MasterToClient.
{ApplicationFailed, ApplicationResult, ApplicationSucceeded, ApplicationTerminated}
import com.leap.cluster.appmaster.WorkerInfo
import com.leap.cluster.scheduler.Resource
import com.leap.jarstore.FilePath
